...
inputstart=datetime.datetime(2019, 1, 1)  #input
startcount=((inputstart - start).days)
# print(startcount)
end = datetime.datetime(2021, 5, 28) 
inputend= datetime.datetime(2019, 12, 31)  #input
endcount=((inputend - end).days)
# print(endcount)
stocknum = 9921


response = requests.get(url % (stocknum,1590710400+startcount*86400,1622246400+endcount*86400))
response.text
